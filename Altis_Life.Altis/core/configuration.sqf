...
life_flutlicht = ObjNull;
life_kegel = ObjNull;
life_respawn_timer = 0.8; //Scaled in minutes
...
switch (playerSide) do
{
	case west: 
	{
		...
		life_paycheck = 9080; //Paycheck Amount
	...
	{
		life_atmcash = 100000; //Starting Bank Money
		life_paycheck = 5020; //Paycheck Amount
		...
		if((getPlayerUID player) in __GETC__(life_gang_adac) ) then {
			life_atmcash = 100000; //Starting Bank Money
			life_paycheck = 10500; //Paycheck Amount
		};
...
[
	...
	["Land_Cargo20_brick_red_F",15000]
];
