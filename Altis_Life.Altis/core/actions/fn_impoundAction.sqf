...
if(!((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Land_Cargo20_red_F"))) exitWith {};
if(player distance cursorTarget > 10) exitWith {};
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship") || (_vehicle isKindOf "Land_Cargo20_red_F")) then
{
	...
	if((count crew _vehicle) == 0) then
	{
		...
		switch (true) do
		{
			...
			case (_vehicle isKindOf "Land_Cargo20_red_F"): {_price = (call life_impound_car);};
		};
