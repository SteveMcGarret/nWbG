...
switch (_shop) do
{
	...
	case "cop": {["Polizei",["donuts","coffee","spikeStrip","water","rabbit","apple","redgull","fuelF","defusekit","absperrung","kegel","flutlicht","pursuit"]]};
	case "cement": {["Cement Dealer",["cement"]]};
	case "goldbar": {["Gold Buyer",["goldbar"]]};
	case "gas": {["Gas Station",["water","rabbit","apple","redgull","tbacon","fuelF","peach"]]};

	// MORE JOBS CONFIG
	case "adac": {["ADAC Item Shop",["donuts","coffee","water","rabbit","apple","redgull","fuelF","lockpick","pursuit","kegel","absperrung","flutlicht"]]};
