...
switch (_var) do
{
	...
	case "life_inv_kegel": {(localize "STR_Item_kegel")};	
	case "life_inv_absperrung": {(localize "STR_Item_absperrung")};	
	case "life_inv_flutlicht": {(localize "STR_Item_flutlicht")};	
	...
	case "life_inv_kegel": {"VerkehrsKegel"};	
	case "life_inv_absperrung": {"Absperrung"};	
	case "life_inv_flutlicht": {"Flutlicht"};	
